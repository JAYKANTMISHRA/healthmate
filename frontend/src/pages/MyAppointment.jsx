              ...
              <div className='flex-1 text-sm text-zinc-600' >
               ...
               <div></div>
                 <div className='flex flex-col gap-2 justify-end'>
                  {!item.cancelled&& item.payment && !item.isCompleted && <button className='sm:min-w-48 py-2 border border-stone-500 rounded text-stone-500 bg-indigo-50'  >Paid</button>}
