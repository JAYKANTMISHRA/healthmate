    ...
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      {
        ...
        <label htmlFor="image">
         <div className='inline-block relative cursor-pointer' >
          <img className='w-36 rounded opacity-90' src={image? URL.createObjectURL(image):userData } alt="" />
          <img className='display: flex;justify-content: center;align-items: center;height: 100px;width: 100px;border-radius: 50%;background-color: #f0f0f0;margin: auto; ' src={image? '' : assets.upload_area } alt="" />
         </div>
